...
| 02 | Dev Tools | Install/Configure Git and VS Code | [Ubuntu Server 20.10 ISO](https://releases.ubuntu.com/20.10/ubuntu-20.10-live-server-amd64.iso) |
...
| 13 | Cloud Virtualization With AWS | AWS Lightsail - VM | [ops201-class14.ova](https://www.icloud.com/iclouddrive/0iOFfu301yYZdLNKhnLV6fRVg#ops201-class14) - 6.41GB, [EaseUS Recovery Tool](https://www.easeus.com/datarecoverywizard/free-data-recovery-software.htm), [Darik's Boot and Nuke (DBAN) ISO file](https://sourceforge.net/projects/dban/files/dban/dban-2.3.0/dban-2.3.0_i586.iso/download) - 15.9 MB |
| 14 | Malware Remediation Tools and Techniques | Diagnose, Fix Malware on PC |  |
